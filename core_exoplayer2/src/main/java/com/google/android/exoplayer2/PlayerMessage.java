...
public final class PlayerMessage {
  ...
  public PlayerMessage(PlayerMessage.Sender sender, PlayerMessage.Target target, Timeline timeline, int defaultWindowIndex, Handler defaultHandler) {
    this.sender = sender;
    this.target = target;
  ...
  public interface Target {
    void handleMessage(int var1, @Nullable Object var2) throws ExoPlaybackException;
  }
}

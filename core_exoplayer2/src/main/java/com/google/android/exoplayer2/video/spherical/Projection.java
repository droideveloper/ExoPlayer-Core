...
public final class Projection {
  ...
  public static Projection createEquirectangular(float radius, int latitudes, int longitudes, float verticalFovDegrees, float horizontalFovDegrees, int stereoMode) {
    ...
    Projection.SubMesh subMesh = new Projection.SubMesh(0, vertexData, textureData, 1);
    return new Projection(new Projection.Mesh(new Projection.SubMesh[]{subMesh}), stereoMode);
  }
  ...
  public Projection(Projection.Mesh leftMesh, Projection.Mesh rightMesh, int stereoMode) {

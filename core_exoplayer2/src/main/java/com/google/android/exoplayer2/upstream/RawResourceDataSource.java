...
public final class RawResourceDataSource extends BaseDataSource {
  ...
  public long open(DataSpec dataSpec) throws RawResourceDataSource.RawResourceDataSourceException {
    try {
      ...
      throw new RawResourceDataSource.RawResourceDataSourceException(var8);
    }
  ...
  public int read(byte[] buffer, int offset, int readLength) throws RawResourceDataSource.RawResourceDataSourceException {
    if (readLength == 0) {
      return 0;
      ...
      try {
        ...
        throw new RawResourceDataSource.RawResourceDataSourceException(var6);
      }
  ...
  public void close() throws RawResourceDataSource.RawResourceDataSourceException {
    ...
    try {
      ...
      throw new RawResourceDataSource.RawResourceDataSourceException(var26);
    } finally {
      ...
      try {
        ...
        throw new RawResourceDataSource.RawResourceDataSourceException(var24);
      } finally {

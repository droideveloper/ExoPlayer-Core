...
public class MediaCodecVideoRenderer extends MediaCodecRenderer {
  ...
  protected void configureCodec(MediaCodecInfo codecInfo, MediaCodec codec, Format format, MediaCrypto crypto, float codecOperatingRate) throws DecoderQueryException {
    ...
    MediaFormat mediaFormat = this.getMediaFormat(format, this.codecMaxValues, codecOperatingRate, this.deviceNeedsAutoFrcWorkaround, this.tunnelingAudioSessionId);
    ...
    if (Util.SDK_INT >= 23 && this.tunneling) {
      this.tunnelingOnFrameRenderedListener = new MediaCodecVideoRenderer.OnFrameRenderedListenerV23(codec);
    }
  ...
  protected MediaFormat getMediaFormat(Format format, MediaCodecVideoRenderer.CodecMaxValues codecMaxValues, float codecOperatingRate, boolean deviceNeedsAutoFrcWorkaround, int tunnelingAudioSessionId) {

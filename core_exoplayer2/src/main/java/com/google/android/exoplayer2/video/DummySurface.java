...
public final class DummySurface extends Surface {
  ...
  public static DummySurface newInstanceV17(Context context, boolean secure) {
    ...
    DummySurface.DummySurfaceThread thread = new DummySurface.DummySurfaceThread();
    return thread.init(secure ? secureMode : 0);
  }

  private DummySurface(DummySurface.DummySurfaceThread thread, SurfaceTexture surfaceTexture, boolean secure) {
